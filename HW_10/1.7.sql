...
-- может быть тяжёлым, то выберем уровень read uncommitted, т.к. +-
-- забронированное или купленное место во время продаж это номальное
-- явление, а когда рейс улетел, то новых продаж и бронирований нет,
-- и запрос будет выдвать точную статистику.